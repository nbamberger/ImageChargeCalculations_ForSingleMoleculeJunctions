function E = interaction_energy_with_jth_images(charges, positions, ...
    ...
    %~~~OUTPUTS~~~:
    %   
    %E: interaction energy between original charges and their jth images in
    %   both the left and right electrodes (i.e. the sum of the two) in
    %   units of eV
    ...
    for i = 1:N
        for j = 1:N
            ...
            E = E + (charges(i)*charges(j)*(-1)^iterNum)/(2*distL) + ...
    ...
    E = E * coulomb_constant * elementary_charge^2 * 1E9;
